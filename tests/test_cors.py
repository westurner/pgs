...
class TestCors(unittest.TestCase):
    ...
    def test_cors_headers_get(self):
        ...
        self.assertEqual(rsp.headers['Access-Control-Allow-Origin'], 'https://example.com')
        self.assertEqual(rsp.headers['Access-Control-Allow-Methods'], 'GET, POST, PUT, DELETE, OPTIONS')
